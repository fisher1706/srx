...
Checking Date Of Last Screen
    ...
    Set Suite Variable              ${hours}
    Set Suite Variable              ${full date without AM PM}
    Set Suite Variable              ${formatted full date}
...
Checking New Item
    ...
    Set Suite Variable              ${ok}       false
    :FOR  ${search counter}         IN RANGE    1           100
    \   Set Suite Variable          ${search index}         1
    \   Search Loop
...
Preparation
    ...
    \   Set Suite Variable          ${checking index}    1
    \   Checking Loop
    \   Exit For Loop If            "${ok}"=="true"
    \   Click Element               css:li.page-item:nth-child(6) > a:nth-child(1)
    \   Sleep                       1 second
...
Check Date
    ...
    Set Suite Variable              ${full date string}
    Set Suite Variable              ${ok}                       true
...
Checking Loop
    ...
    \   Set Suite Variable          ${checking index}
...
Search Loop
    ...
    \   Set Suite Variable          ${search index}
