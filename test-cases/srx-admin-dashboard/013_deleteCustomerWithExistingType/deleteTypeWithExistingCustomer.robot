...
Checking New Customer Type On Distributor Portal Not Delete
    ...
    Click Element                   css:.modal-dialog-ok-button
    Sleep                           5 second
    Element Text Should Be          xpath:/html/body/div/div/div/div/div/div[2]/div/div[2]/div/div/div[3]/div/div/div/div/div[1]/div[2]/table/tbody/tr[${static row c}]/td[4]/div      ${test del type}
    Finish Suite
