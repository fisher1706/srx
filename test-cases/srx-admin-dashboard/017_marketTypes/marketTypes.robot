...
Checking New Market Type In Table
    Sleep                           5 second
    Element Text Should Be          xpath:/html/body/div/div/div/div[2]/div/div[2]/div/div/div[3]/div/div/div/div/div[1]/div[2]/table/tbody/tr[${number of new row}]/td[2]/div          ${market type}
...
Checking New Market Type On Distributor Portal
    ...
    Click Element                   css:.modal-dialog-ok-button
    Sleep                           5 second
    Element Text Should Be          xpath:/html/body/div/div/div/div/div/div[2]/div/div[2]/div/div/div[3]/div/div/div/div/div[1]/div[2]/table/tbody/tr[${static row c}]/td[5]/div      ${market type}
    Click Element                   ${edit customer button sub}
    Go Up
    Sleep                           1 second
    Click Element                   css:.modal-dialog-ok-button
...
Delete Market Type
    ...
    Is Market Types
    Click Element                   ${delete button}
    Element Text Should Be          xpath:/html/body/div[2]/div[2]/div/div/div[2]/div/table/tbody/tr/td[2]          ${edit market type}
...
Go Down
    ...
    Sleep                           1 second
    Run Keyword If                  "${text buffer sub}"!="${market type}"        Go Down
...
Go Up
    ...
    ${text buffer sub}              Get Text                                    xpath:/html/body/div[2]/div[2]/div/div/div[2]/div/div/form/div/div[4]/div/div/div/div[1]/div[1]/span
    Sleep                           1 second
    Run Keyword If                  "${text buffer sub}"!="Not specified"       Go Up