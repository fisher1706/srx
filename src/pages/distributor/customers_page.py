...
class CustomersPage(DistributorPortalPage):
    ...
    def open_customer_users(self, row):
        self.click_xpath(Locator.xpath_by_count(Locator.title_manage_customer_users, row))
    ...
    def update_last_customer(self, customer_body):
        self.click_xpath(Locator.xpath_by_count(Locator.xpath_table_row, self.get_table_rows_number())+Locator.title_customer_info)
        self.select_in_dropdown(Locator.xpath_dropdown_in_dialog(1), customer_body.pop("customerType"))
        self.select_in_dropdown(Locator.xpath_dropdown_in_dialog(2), customer_body.pop("marketType"))
    ...
    def delete_last_customer(self):
        ...
        self.click_xpath(Locator.xpath_by_count(Locator.title_delete_customer, self.get_table_rows_number()))
