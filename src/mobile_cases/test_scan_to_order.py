...
def test_bulk_create_transaction(mobile_api, permission_api, permissions, delete_shipto, delete_distributor_security_group):
...
@pytest.mark.acl
@pytest.mark.regression
def test_bulk_create_transaction_without_permission(mobile_api, permission_api, delete_shipto, delete_distributor_security_group):
...
@pytest.mark.regression
def test_bulk_create_transaction_for_non_exist_sku(mobile_api, delete_shipto):
...
@pytest.mark.regression
def test_bulk_create_transaction_with_zero_quantity(mobile_api, delete_shipto):
...
@pytest.mark.regression
def test_bulk_create_transaction_with_asset_flag(mobile_api, delete_shipto):
...
@pytest.mark.regression
def test_bulk_create_for_exist_transactions_in_active(mobile_api, conditions, delete_shipto):
...
@pytest.mark.regression
def test_bulk_create_for_exist_transactions_in_different_status(mobile_api, conditions, delete_shipto):
    mobile_api.testrail_case_id = conditions["testrail_case_id"]
    mta = MobileTransactionApi(mobile_api)
    ta = TransactionApi(mobile_api)
