...
class TestButtons():
    ...
    def test_assign_dsn_to_button(self, mobile_api, permission_api, permissions, delete_shipto, delete_distributor_security_group):
    ...
    @pytest.mark.acl
    @pytest.mark.regression
    def test_assign_dsn_to_button_without_permissions(self, mobile_api, permission_api, delete_shipto, delete_distributor_security_group):
    ...
    @pytest.mark.acl
    @pytest.mark.regression
    def test_unassign_dsn_from_button(self, mobile_api, permission_api, permissions, delete_shipto, delete_distributor_security_group):
        mobile_api.testrail_case_id = permissions["testrail_case_id"]
        context = Permissions.set_configured_user(mobile_api, permissions["user"], permission_context=permission_api)
        la = LocationApi(context)
