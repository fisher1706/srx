...
class TestMobileRfidManage():
    ...
    def test_create_label_for_rfid_with_permission(self, mobile_api, delete_shipto):
    ...
    @pytest.mark.regression
    def test_delete_label_for_rfid_with_permission(self, mobile_api, conditions, delete_shipto):
    ...
    @pytest.mark.acl
    @pytest.mark.regression
    def test_delete_label_for_rfid_without_permission(self, mobile_api, permission_api, delete_shipto, delete_distributor_security_group):
    ...
    @pytest.mark.regression
    def test_delete_available_label_for_rfid_with_reoreder(self, mobile_api, conditions, delete_shipto):
