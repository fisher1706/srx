...
@pytest.mark.acl
@pytest.mark.regression
def test_rfid_crud_view_permission(api, permission_api, delete_distributor_security_group, delete_shipto):
...
@pytest.mark.regression
def test_create_rfid_transaction_as_issued(api, delete_shipto, delete_hardware):
...
@pytest.mark.regression
def test_create_rfid_transaction_at_min(api, delete_shipto, delete_hardware):
...
@pytest.mark.regression
def test_can_read_rfid_label_only_from_correct_shipto(api, delete_shipto, delete_hardware):
...
@pytest.mark.regression
def test_full_return_rfid_available_flow(api, delete_shipto, delete_hardware):
...
@pytest.mark.regression
def test_full_rfid_available_flow(api, delete_shipto, delete_hardware):
