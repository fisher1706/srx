...
def test_sn_expires_when_enable_auto_expire(api, delete_shipto):
...
@pytest.mark.regression
def test_sn_created_in_expired_status_when_auto_expire_enabled(api, delete_shipto):
...
@pytest.mark.regression
def test_sn_expires_when_update_doe_if_auto_expire_enabled(api, delete_shipto):
...
@pytest.mark.regression
def test_create_sn_in_expired_status_without_settings(api, delete_shipto):
...
@pytest.mark.regression
def test_update_sn_to_expired_status_without_settings(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_assigned_from_expired_when_create_in_expired_and_disabled_setting(api, conditions, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_assigned_from_expired_when_create_in_assigned_and_disabled_setting(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_available_from_expired_when_disabled_setting(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_no_expiration_alarm_when_update_to_issued(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_no_expiration_alarm_when_update_doe(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_issued_sn_cannot_be_expired_when_update_doe_without_auto_expire(conditions, api, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_issued_sn_cannot_be_expired_when_update_doe_with_auto_expire(conditions, api, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_issued_sn_cannot_be_expired_when_turn_on_auto_expire(conditions, api, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_return_sn_to_assigned_from_expired_when_update_doe_and_enabled_setting(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_return_sn_to_available_from_expired_when_update_doe_and_enabled_setting(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_assigned_from_expired_when_turn_off_settings(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_available_from_expired_when_turn_off_settings(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_assigned_from_expired_when_update_days_for_settings(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_available_from_expired_when_update_days_for_settings(api, delete_shipto):
...
@pytest.mark.regression
def test_full_expire_in_alarm_flow(api, delete_shipto):
...
@pytest.mark.regression
def test_return_sn_to_assigned_from_expired_when_turn_on_settings_and_update_doe(api, delete_shipto):
