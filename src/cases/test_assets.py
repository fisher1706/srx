...
@pytest.mark.regression
def test_checkout_asset_customer_checkout_user(api, delete_shipto):
...
@pytest.mark.regression
def test_create_location_for_asset(api, delete_shipto):
...
@pytest.mark.regression
def test_delete_location_for_asset(api, delete_shipto):
...
@pytest.mark.regression
def test_issue_return_assets_rfid(api, delete_shipto, delete_hardware):
...
@pytest.mark.regression
def test_update_asset_location(api, delete_shipto):
...
@pytest.mark.regression
def test_create_asset_product_with_package_conversion_and_round_buy_and_issue_quantity(api, conditions):
...
@pytest.mark.regression
def test_update_asset_product_with_package_conversion_and_round_buy_and_issue_quantity_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
