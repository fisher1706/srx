...
def test_create_transaction_at_min_by_ohi_update(api, conditions, delete_shipto):
...
@pytest.mark.regression
def test_create_transaction_as_issued_by_ohi_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_close_transaction_by_ohi_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_reorder_quantity_as_issued(api, delete_shipto):
...
@pytest.mark.regression
def test_close_transaction_by_pack_conversion_update(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_transaction_quantity_by_pack_conversion_update(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_create_transaction_by_min_max_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_close_transaction_by_min_max_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_transaction_by_min_max_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_create_transaction_rfid_by_updated_issue_qnt(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
    ...
    product_dto = copy.deepcopy(response_location["product"])
    product_dto["issueQuantity"] /= conditions["created_coeff"]
    pa.update_product(dto=product_dto, product_id=response_location["product"]["id"])
    time.sleep(5)
    transaction_updated = ta.get_transaction(shipto_id=response_location["shipto_id"])["entities"]
    assert transaction_updated[0]["status"] == "ACTIVE"
...
@pytest.mark.regression
def test_update_transaction_rfid_by_updated_issue_qnt(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_close_transaction_rfid_by_updated_issue_qnt(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_create_transaction_by_sn_status_update_at_min(api, delete_shipto):
...
@pytest.mark.regression
def test_create_transaction_by_sn_status_update_as_issued(api, delete_shipto):
...
@pytest.mark.regression
def test_close_transaction_by_sn_status_update_at_min(api, delete_shipto):
...
@pytest.mark.regression
def test_close_transaction_by_sn_status_update_as_issued(api, delete_shipto):
...
@pytest.mark.regression
def test_update_transaction_by_sn_status_update_as_issued(conditions, api, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
    ...
    assert quantity_updated == quantity*conditions["coef"]
...
@pytest.mark.regression
def test_reorder_controls_with_quantity_on_reorder(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_with_quantity_on_reorder_with_several_same_statuses(api, delete_shipto):
...
@pytest.mark.regression
def test_reorder_controls_update_quantity_on_reorder_qnty_with_existing_active_for_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_update_quantity_on_reorder_status_with_existing_active_for_create(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_update_quantity_on_reorder_qnty_with_existing_active_for_create(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_update_active_transaction(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_is_not_triggered_by_update_transaction_from_customer_portal(api, delete_shipto):
    ...
    rla.update_replenishment_item(response_location["shipto_id"], transaction_id, LOCATION_MAX-1)
...
@pytest.mark.regression
def test_reorder_controls_submit_replenishment_list_for_create(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_update_quantity_on_reorder_status_with_existing_active_for_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_with_quantity_on_reorder_update_min_and_max_for_create(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_with_quantity_on_reorder_update_min_and_max_for_update(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_reorder_controls_rounding(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_create_transaction_by_pack_conversion_update_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_close_transaction_by_pack_conversion_update_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_transaction_quantity_by_pack_conversion_update_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_create_transaction_rfid_by_updated_issue_qnt_with_clc(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_transaction_rfid_by_updated_issue_qnt_with_clc(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_close_transaction_rfid_by_updated_issue_qnt_with_clc(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_create_transaction_by_pack_conversion_update_for_distributor_catalog_only_if_clc_off(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
def test_create_transaction_at_min_by_ohi_update_on_customer_portal_supplier(api, conditions, customer_organization_location_preset, delete_site, delete_subsite, delete_supplier):
    ...
    location["onHandInventory"] = preset["location"]["orderingConfig"]["currentInventoryControls"]["min"]*conditions["coefficient"]
    cla.update_location([location])
    time.sleep(5)
    transaction = rla.get_replenishment_list(shipto_ids=preset["organization"]["shipto_id"])
    assert len(transaction) == conditions["transaction_qty"], f"The number of transactions should be equal to {conditions['transaction_qty']}"
    if conditions["transaction_qty"] != 0:
        assert transaction[0]["reorderQuantity"] == (preset["product"]["roundBuy"]*conditions["reorder_qty_coefficient"]), \
            f"Reorder quantity of transaction should be equal to {preset['product']['roundBuy']*conditions['reorder_qty_coefficient']}"
...
def test_reorder_controls_doesnt_work_for_buttons(api, delete_shipto):
    ...
    setup_location.add_option("dsn", Tools.random_string_l())
    response_location = setup_location.setup()

    #close transaction
    transactions = ta.get_transaction(sku=response_location["product"]["partSku"], shipto_id=response_location["shipto_id"], status="ACTIVE")["entities"]
    assert len(transactions) == 1
    transaction_id = transactions[0]["id"]
    reorder_quantity = transactions[0]["reorderQuantity"]
