...
def test_csku_is_copied_into_clc_after_clc_on(api, delete_customer):
...
@pytest.mark.regression
def test_cannot_create_location_with_incorrect_min_max_with_clc(api, delete_customer):
...
@pytest.mark.regression
def test_cannot_update_customer_product_round_buy_with_incorrect_min_max(api, delete_customer):
...
@pytest.mark.regression
def test_update_distributor_product_round_by_when_incorrect_min_max_with_clc(api, delete_customer):
...
@pytest.mark.regression
def test_create_variant_when_update_clc(api, delete_customer):
