...
def test_location_of_serialized_product(api, delete_shipto):
...
@pytest.mark.regression
def test_lot_product_should_be_serializable(api):
...
@pytest.mark.regression
def test_lot_location_should_be_serializable(api, delete_shipto):
...
@pytest.mark.regression
def test_package_conversion_and_round_buy_of_serialized_product(api, conditions):
...
@pytest.mark.regression
def test_package_conversion_and_round_buy_of_serialized_location(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_disable_serialization_for_catalog_and_check_location(api, delete_shipto):
...
@pytest.mark.regression
def test_serialization_default_product_values(api):
...
@pytest.mark.regression
def test_serialization_default_location_values(api, delete_shipto):
...
@pytest.mark.regression
def test_update_package_conversion_and_round_buy_of_serialized_product(conditions, api):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_package_conversion_and_round_buy_of_product_with_serialized_location(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_package_conversion_and_round_buy_of_distributor_product_with_serialized_location_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_package_conversion_and_round_buy_of_product_with_serialized_location_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_ohi_of_created_serialized_product_location(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_of_created_serialized_location(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_location_updated_to_serialized(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_product_location_updated_to_serialized(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_of_serialized_asset_product_location(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_of_serialized_asset_location(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_of_updated_serialized_product_location(api, delete_shipto):
...
@pytest.mark.regression
def test_ohi_of_updated_serialized_location(api, delete_shipto):
...
@pytest.mark.regression
def test_update_location_to_serialized_with_package_conversion_and_round_buy(api, conditions, delete_shipto):
    api.testrail_case_id = conditions["testrail_case_id"]
...
@pytest.mark.regression
def test_update_location_to_serialized_with_package_conversion_and_round_buy_with_clc(api, conditions, delete_customer):
    api.testrail_case_id = conditions["testrail_case_id"]
