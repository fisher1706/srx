...
def universal_catalog_crud(case):
    ...
    case.testrail_config(case.activity.variables.run_number, 1857)
    ...
    try:
        ...
        #-------------------
        edit_universal_product_body["manufacturerPartNumber"] = case.random_string_u(18)
        edit_universal_product_body["manufacturer"] = case.random_string_u(18)
        edit_universal_product_body["gtin"] = case.random_string_u(18)
        edit_universal_product_body["upc"] = case.random_string_u(18)
        #-------------------
