...
def warehouse_crud(case):
    ...
    try:
        ...
        wp.update_last_warehouse(name=edit_name, number=edit_number, address1=edit_address1, address2=edit_address2, city=edit_city, state=edit_state, code=edit_code, timezone=edit_timezone, contact_email=edit_contact_email, invoice_email=edit_invoice_email)
