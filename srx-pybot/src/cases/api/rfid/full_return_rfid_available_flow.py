...
def full_return_rfid_available_flow(case):
    ...
    try:
        ...
        ra.update_rfid_label(rfid_location_response["location_id"], rfid_location_response["labels"][0]["rfid_id"], "ISSUED")
...
if __name__ == "__main__":
    full_return_rfid_available_flow(Case(Activity(api_test=True)))