...
${delete super user}            //button[contains(@title, 'Delete Super User')]
${delete fob}                   //button[contains(@title, 'Delete FOB')]
${edit user}                    //button[contains(@title, 'Edit User')]
${edit super user}              //button[contains(@title, 'Edit Super User')]
...
${edit security group}          //button[contains(@title, 'Edit Security group')]
${delete security group}        //button[contains(@title, 'Delete Security group')]
${edit serial number}           //button[contains(@title, 'Edit serial number')]
...
${general permission card}      ${dialog}//span[text()="Permissions"]/../..
${settings permission card}     ${dialog}//span[text()="Permissions for settings"]/../..