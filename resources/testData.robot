...
${edit full adress}             Edit Adress 1 Edit Adress 2 Edit City AZ 89000
${edit city}                    Edit City
...
${select is focused}            //div[contains(@class, 'css-wqgs6e')]
...
${contact info}                 //div[contains(@id, 'enterprise-profile-pane-contact-info')]
...
${list group}                   //div[contains(@class, 'list-group')]
