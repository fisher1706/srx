...
${documents pane}               //a[contains(@id, 'pricing-billing-tab-documents')]
${keys pane}                    //a[contains(@id, 'erp-integration-tab-api-keys')]
${taxes pane}                   //a[contains(@id, 'pricing-billing-tab-taxes')]